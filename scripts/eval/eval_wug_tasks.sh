...
#SBATCH --output=logs/eval_wug_%j.out
#SBATCH --error=logs/eval_wug_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=32G
...
# ======================================================
# 🔧 WUG TASKS EVALUATION (Morphological Generalization)
# ======================================================
...
# Evaluate WUG Adjective Nominalization
echo ""
echo "=== Evaluating WUG_ADJ (Adjective Nominalization) ==="
...
# Evaluate WUG Past Tense
echo ""
echo "=== Evaluating WUG_PAST (Past Tense Formation) ==="
python -m evaluation_pipeline.sentence_zero_shot.run \
  --model_path_or_name $CHECKPOINT_DIR \
  --backend $BACKEND \
  --task wug_past \
