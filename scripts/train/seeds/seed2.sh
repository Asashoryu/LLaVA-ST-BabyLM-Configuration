#!/bin/bash
#SBATCH --job-name=baby_exp3_seed2
#SBATCH --output=logs/train_exp3_seed2_%j.out
#SBATCH --error=logs/train_exp3_seed2_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
...
# ============================================================
# EXPERIMENT 3 RUN 2 - Seed 123
# ============================================================
EXP_ID=3
PROJECT_VERSION="23_seed2"
SEED=123
...
echo "================================================"
echo "EXPERIMENT 3 - STATISTICAL VALIDATION RUN 2"
echo "================================================"
