#!/bin/bash
#SBATCH --job-name=baby_exp3_seed4
#SBATCH --output=logs/train_exp3_seed4_%j.out
#SBATCH --error=logs/train_exp3_seed4_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
...
# ============================================================
# EXPERIMENT 3 RUN 4 - Seed 789
# ============================================================
EXP_ID=3
PROJECT_VERSION="23_seed4"
SEED=789
...
echo "================================================"
echo "EXPERIMENT 3 - STATISTICAL VALIDATION RUN 4"
echo "================================================"
