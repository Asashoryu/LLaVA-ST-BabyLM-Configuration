#!/bin/bash
#SBATCH --job-name=baby_exp3_seed1
#SBATCH --output=logs/train_exp3_seed1_%j.out
#SBATCH --error=logs/train_exp3_seed1_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
...
# ============================================================
# EXPERIMENT 3 RUN 1 - Seed 42 (Original Gen 23 run)
# ============================================================
EXP_ID=3
PROJECT_VERSION="23_seed1"
SEED=17
...
echo "================================================"
echo "EXPERIMENT 3 - STATISTICAL VALIDATION RUN 1"
echo "================================================"
echo "Model:          $MODEL_PATH"
echo "Dataset:        $DATA_PATH"
echo "Output:         $OUTPUT_DIR"
echo "Seed:           $SEED (Gen 23 original)"
